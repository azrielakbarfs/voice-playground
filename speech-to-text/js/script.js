  ...
  var ResponsiveVoice = function () {
      ...
      a.responsivevoices = [
        {
          ...
          lang: "en-GB",
          voiceIDs: [
            3, 7, 171, 278, 201, 5, 1, 257, 286, 342, 258, 287, 343, 8,
          ],
        },
        {
        ...
        },
        {
          ...
          lang: "en-US",
          voiceIDs: [
            39, 40, 41, 42, 383, 205, 204, 43, 173, 235, 283, 339, 408, 44,
          ],
        },
        {
          ...
          lang: "en-US",
          voiceIDs: [
            234, 282, 338, 236, 284, 340, 237, 382, 2, 4, 0, 6, 7, 75, 159,
          ],
        },
        {
          name: "Arabic Male",
        ...
        },
        {
          ...
          lang: "zh-CN",
          voiceIDs: [
            249, 58, 59, 380, 281, 231, 155, 60, 191, 268, 297, 353, 269, 298,
            354, 409, 61,
          ],
        },
        {
        ...
        },
        {
          ...
          lang: "zh-TW",
          voiceIDs: [
            194, 233, 253, 254, 305, 322, 361, 384, 319, 336, 375, 409, 255,
          ],
        },
        {
        ...
        },
        {
          ...
          lang: "de-DE",
          voiceIDs: [
            27, 28, 29, 30, 78, 170, 275, 199, 31, 261, 290, 346, 262, 291, 347,
            32,
          ],
        },
        {
        ...
        },
        {
          ...
          lang: "fr-FR",
          voiceIDs: [
            240, 21, 22, 23, 77, 178, 279, 210, 266, 295, 351, 304, 321, 360,
            26,
          ],
        },
        {
        ...
        },
        {
          ...
          lang: "ja-JP",
          voiceIDs: [
            248, 50, 51, 280, 217, 52, 153, 182, 273, 302, 358, 274, 303, 359,
            53,
          ],
        },
        {
        ...
        },
        {
          ...
          lang: "es-ES",
          voiceIDs: [
            19, 238, 16, 17, 18, 20, 76, 174, 207, 263, 292, 348, 264, 293, 349,
            15,
          ],
        },
        {
      ...
      a.speak = function (b, c, d) {
        if (a.rvsMapped) {
          ...
          if (a.isPlaying())
                ...
                if (-1 == g || g >= a.CHARACTER_LIMIT) {
                  ...
                  for (g = 0; g < l.length; g++) {
                    if (e.length + l[g].length + 1 > a.CHARACTER_LIMIT) {
                      l[g].length >= a.CHARACTER_LIMIT &&
                        (e += l[g].substr(0, a.CHARACTER_LIMIT - e.length - 1));
                      break;
                    }
                    e += (0 != g ? " " : "") + l[g];
                  }
            ...
            a.multipartText = k;
            null == c
              ? ((g = a.default_rv), a.setDefaultVoice(g.name))
              : (g = a.getResponsiveVoice(c));
            !0 === g.deprecated &&
              console.warn(
              ...
              for (g = 0; g < k.length; g++)
                if (
                  ...
                  a.log("Using SpeechSynthesis"),
                    ...
                    (e.voiceURI = f.systemvoice.voiceURI),
                  ...
                  e =
                    ...
                    "&vn=" +
                    (f.collectionvoice.voicename ||
                      f.systemvoice.voicename ||
                      "") +
                    "&pitch=" +
                    e.toString() +
                    "&rate=" +
      ...
      a.checkSpeechAllowed = function (b) {
        ...
        if (
          (a.is_android ||
            a.iOS ||
            (a.is_safari && (a.fallbackMode || a.forcedFallbackMode))) &&
